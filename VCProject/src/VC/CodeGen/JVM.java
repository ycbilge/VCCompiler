...
public final class JVM {
	...
	public final static String SOURCE = ".source",
			...
			GOTO = "goto", IFEQ = "ifeq", IFNE = "ifne", IFLE = "ifle",
			IFLT = "iflt", IFGE = "ifge", IFGT = "ifgt",
			IF_ICMPEQ = "if_icmpeq", IF_ICMPNE = "if_icmpne",
			IF_ICMPLE = "if_icmple", IF_ICMPLT = "if_icmplt",
			IF_ICMPGE = "if_icmpge", IF_ICMPGT = "if_icmpgt",
			...
			DUP = "dup", POP = "pop", NOP = "nop",
			// array type
			IALOAD = "iaload", FALOAD = "faload", BALOAD = "Baload";

	// Limitations of the JVM

	public final static int MAX_BYTE = 255, // 2^8 -1
			MAX_SHORT = 65535, // 2^16 - 1
			MAX_LOCALVARINDEX = MAX_SHORT, MAX_OPSTACK = MAX_SHORT;
}
